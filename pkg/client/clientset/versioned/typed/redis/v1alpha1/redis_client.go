...
import (
	...
	"github.com/zdq0394/redis-cluster-operator/pkg/client/clientset/versioned/scheme"
...
// RedisV1alpha1Client is used to interact with features provided by the redis.zdq0394.io group.
type RedisV1alpha1Client struct {
	restClient rest.Interface
}

func (c *RedisV1alpha1Client) RedisClusters(namespace string) RedisClusterInterface {
